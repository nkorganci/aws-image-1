...
output "jenkins_iam_role_name" {
  description = "IAM role name for Jenkins server to attach for SSM access"
  value       = aws_iam_role.jenkins_ssm_role.name
}

output "jenkins_iam_role_arn" {
  description = "IAM role ARN for Jenkins server"
